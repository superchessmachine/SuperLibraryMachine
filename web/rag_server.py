...
if sys.version_info >= (3, 13):
    raise RuntimeError(
        "Python 3.13+ is not yet supported because faiss-cpu depends on numpy<2.0. "
        "Please recreate your environment with Python 3.10–3.12 before running SuperLibraryMachine."
    )
